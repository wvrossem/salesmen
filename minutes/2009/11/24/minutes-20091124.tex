...
There were no members absent.
		...
		\subsection{Revision History}
			\begin{tabular}{c | l | l }
				...
				1.1 & November 26, 2009 & Revised by QA Manager \\
				1.2 & November 26, 2009 & Revised by Project Manager \\
				1.3 & November 26, 2009 & Revised by Project Secretary \\
				1.4 & November 26, 2009 & Ready to be uploaded \\
...
There has to be requirements that specifies all the costs for placing an object and for selling an object (e.g. 5\% of the selling price)
			\end{itemize}
Moreover, the SRS has been compared to that of the other groups.
For a full list, one can look at the difference report of the SRS which will be available on the project website soon. 
...
In general, the SCMP of Salesmen is more complete than that of the other groups. For a full list, one can have a look at the difference report of the SCMP which will be available on the project website soon.
	...
	\section{SQAP}
There are tools available in Eclipse to ease the use of coding conventions. The Quality Assurance Manager will propose some coding conventions at the meeting on Tuesday, December 1. 
