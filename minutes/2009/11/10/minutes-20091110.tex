...
e.g. The owner of an object that is being sold is not permitted to bid at his own sales.
				\item Warnings (Want to have) \\
e.g. There will be given a warning when a user tries to create a new account on the same e-mail address. Having several accounts on the same e-mail address will be allowed, however the user will receive a warning to remind him about these other account(s).
