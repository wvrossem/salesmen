...
The role of the Quality Assurance Manager was not clear enough in our team. It looked like the Quality Manager had more work than strictly necessary. This is why this role has been thoroughly discussed in this meeting. There has been decided that it is important to be consistent all over the project and that the role of the Quality Assurance Manager has to be taken seriously. In the future, he will also look for consistency in the code (for ex. ambiguous names of variables should be avoided). This is a public project, so names of variables should be chosen carefully. However unnecessary changes in the code are not important. One should always consider the time spent on optimizing the code versus just renaming variables without adding extra functionality or readability. For checking the code, the QA Manager will use specific tests to improve the code.
...
The requirements will be divided into 3 classes: ``Must have'', ``Want to have''  and ``Nice to have''. This is only a basic, incomplete and non-binding description of the Requirements, as discussed in the meeting on Friday, October 30, 2009. For a full description of the requirements, one should look at the SRS.
	...
	There is a good probability that these features will be included in the project.
		\begin{itemize}
	...
	Under the condition that there is still time left, these features might be included in the project.
		\begin{itemize}
