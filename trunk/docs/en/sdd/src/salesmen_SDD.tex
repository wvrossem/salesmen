...
%this piece of code generates the header
\pagestyle{fancy}
...
%and this is the end of the header-code

\date{25 November 2009}
\author{Bart Maes}
\title{Software Engineering Group 2 (2009-2010)\\Software Design Description}
...
\item Application tier (Business Logic/Logic Tier)
