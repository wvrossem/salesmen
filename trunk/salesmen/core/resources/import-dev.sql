...
insert into auction (title,description,startingprice,status, category_id, version, user_id,startDate,endDate,hotAuction) values ('Uber formal unentscheidbare Satze der Principia Mathematica und verwandter','By Kurt Godel',10.2,1,4,0,2,now(),now(), false);
