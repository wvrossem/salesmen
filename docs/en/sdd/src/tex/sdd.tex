...
Prototypes of the webinterface can be found in Appendix A.
\pagebreak
...
Entity-Relationship diagram: see Appendix A.
...
% Begin Use Cases
% ------------------------------------------------------------------------
%\input{../../../srs/src/tex/specific-requirements.tex}
...
\begin{figure}
\includegraphics[scale=0.4]{../../img/erd1.jpg}
