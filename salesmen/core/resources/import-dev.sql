...
insert into Member (screenname, firstname, lastname, email) values ('Mr_Smiley', 'Mr', 'Smiley', 'smiley@nowhere.com')
insert into Member (screenname, firstname, lastname, email) values ('duke', 'duke', 'McDuke', 'duke@sun.com')
insert into Member (screenname, firstname, lastname, email) values ('shadowman', 'shadow', 'man', 'shadowman@redhat.com')
insert into Member (screenname, firstname, lastname, email) values ('mona', 'mona', 'lisa', 'monalisa@louvre.fr')
