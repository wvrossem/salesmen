...
insert into auction (title,description,startingprice,status, category_id, version, user_id,startDate,endDate,hotAuction) values ('Götterdämmerung','...',10.2,1,8,0,2,now(),now(), false);
...
insert into auction (title,description,startingprice,status, category_id, version, user_id,startDate,endDate,hotAuction) values ('Discourse on the Method','By René Descartes',10.2,1,5,0,2,now(),now(), false);
...
insert into auction (title,description,startingprice,status, category_id, version, user_id,startDate,endDate,hotAuction) values ('Metaphysical Foundations of Natural Science','By Immanuel Kant',12.3,1,3,0,2,now(),now(),false);
insert into auction (title,description,startingprice,status, category_id, version, user_id,startDate,endDate,hotAuction) values ('Über formal unentscheidbare Sätze der Principia Mathematica und verwandter','By Kurt Gödel',10.2,1,4,0,2,now(),now(), false);
insert into auction (title,description,startingprice,status, category_id, version, user_id,startDate,endDate,hotAuction) values ('The GNU Manifesto','By Richard Stallman',10.2,1,8,0,2,now(),now(), false);
insert into auction (title,description,startingprice,status, category_id, version, user_id,startDate,endDate,hotAuction) values ('An Enquiry concerning Human Understanding','By David Hume',10.2,1,7,0,2,now(),now(), true);
insert into auction (title,description,startingprice,status, category_id, version, user_id,startDate,endDate,hotAuction) values ('Aspects of the theory of syntax.','By Noam Chomskey',10.2,1,12,0,2,now(),now(), true);
...
insert into auction (title,description,startingprice,status, category_id, version, user_id,startDate,endDate,hotAuction) values ('Déjeuner sur l\'herbe','Painting  by Édouard Manet.',10.2,1,11, 0,2,now(),now(), false);
insert into auction (title,description,startingprice,status, category_id, version, user_id,startDate,endDate,hotAuction) values ('Eine Kleine Nachtmusik','Serenade  by Wolfgang Amadeus Mozart.',10.2,1,10,0,2,now(),now(), false);
